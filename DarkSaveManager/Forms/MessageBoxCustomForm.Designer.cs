...
partial class MessageBoxCustomForm
{
    ...
    {
        this.MessageTopLabel = new DarkSaveManager.Forms.CustomControls.DarkLabel();
        ...
        this.ChoiceListBox = new DarkSaveManager.Forms.CustomControls.DarkListBox();
        this.SelectButtonsFLP = new System.Windows.Forms.FlowLayoutPanel();
        this.SelectAllButton = new DarkSaveManager.Forms.CustomControls.StandardButton();
        this.MessageBottomLabel = new DarkSaveManager.Forms.CustomControls.DarkLabel();
        this.OuterTLP = new System.Windows.Forms.TableLayoutPanel();
        this.BottomFLP = new System.Windows.Forms.FlowLayoutPanel();
        this.Cancel_Button = new DarkSaveManager.Forms.CustomControls.StandardButton();
        this.OKButton = new DarkSaveManager.Forms.CustomControls.StandardButton();
    ...
    private DarkSaveManager.Forms.CustomControls.DarkLabel MessageTopLabel;
    ...
    private DarkSaveManager.Forms.CustomControls.DarkListBox ChoiceListBox;
    private DarkSaveManager.Forms.CustomControls.DarkLabel MessageBottomLabel;
    private System.Windows.Forms.FlowLayoutPanel SelectButtonsFLP;
    private DarkSaveManager.Forms.CustomControls.StandardButton SelectAllButton;
    private DarkSaveManager.Forms.CustomControls.StandardButton Cancel_Button;
    private DarkSaveManager.Forms.CustomControls.StandardButton OKButton;
}
