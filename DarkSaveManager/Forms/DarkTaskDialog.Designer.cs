...
partial class DarkTaskDialog
{
    ...
    private void InitializeComponent()
    {
        ...
        this.ViewLogButton = new DarkSaveManager.Forms.CustomControls.DarkButton();
        this.Cancel_Button = new DarkSaveManager.Forms.CustomControls.DarkButton();
        this.NoButton = new DarkSaveManager.Forms.CustomControls.DarkButton();
        this.YesButton = new DarkSaveManager.Forms.CustomControls.DarkButton();
        this.VerificationCheckBox = new DarkSaveManager.Forms.CustomControls.DarkCheckBox();
        this.MessageLabel = new DarkSaveManager.Forms.CustomControls.DarkLabel();
